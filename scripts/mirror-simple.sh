...
rsync -rltJOve ssh --partial --progress --perms --chmod=Dugo+x,ugo+r,go-w $CUSTOM_EXCLUDE --exclude *.cme --exclude *.cme.run --exclude stage1*.tar* --exclude stage2*.tar* --exclude *.tar $mp/1.4-release-std/ drobbins@upload.funtoo.org:/home/mirror/funtoo/1.4-release-std/
...
rsync -rltJOve ssh --partial --progress --perms --chmod=Dugo+x,ugo+r,go-w $CUSTOM_EXCLUDE --exclude *.cme --exclude *.cme.run --exclude stage1*.tar* --exclude stage2*.tar* --exclude *.tar $mp/1.4-release-std/ drobbins@upload.funtoo.org:/home/mirror/funtoo/1.4-release-std/ --delete
# reindex again.
ssh drobbins@upload.funtoo.org development/metro/scripts/buildrepo index.xml
